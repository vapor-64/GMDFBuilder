...
const SAMPLE_VARIANTS = {
  ...
  "i18n": {
    ...
    i18nData: {
      ...
      "link.nexus":      "Visit the Nexus Mods page",
      "link.internal":   "→ See crafting recipes (Details page)",
      "page.details":    "Details",
      "section.intro":   "Introduction",
      "intro.text":      "This section appears at the top of the Details page. The internal link from Overview scrolls past this section to reach Crafting Recipes below.",
      "intro.item1":     "This is the first section on the Details page",
      "intro.item2":     "The internal link target is further down",
      "intro.item3":     "Scroll down to see where the link lands",
      "section.foraging": "Foraging & Drops",
      "foraging.intro":  "Lorem ipsum dolor sit amet, consectetur adipiscing elit. This section is between the intro and the crafting anchor — more content for the link to scroll past.",
      "foraging.item1":  "Spring Onion — found in Cindersap Forest in Spring",
      "foraging.item2":  "Daffodil — common forage item in Spring",
      "foraging.item3":  "Leek — forages in Spring, sells for 60g",
      "foraging.item4":  "Dandelion — found in Spring, used in cooking",
      "foraging.note":   "Forage items can be sold, gifted, or used in cooking recipes. Quality increases with Foraging skill level.",
      "section.crafting": "Crafting Recipes",
      "crafting.intro":  "You arrived here via the internal link from the Overview page. The anchor \"crafting-anchor\" targets this section specifically, scrolling past the intro and foraging sections above.",
      "section.upgrades": "Upgrade Costs",
      "upgrades.intro":  "Tool upgrades are purchased from Clint the Blacksmith. Each upgrade improves the tool's efficiency and reach.",
      "upgrades.item1":  "Copper — 2,000g + 5 Copper Bars",
      "upgrades.item2":  "Steel — 5,000g + 5 Iron Bars",
      "upgrades.item3":  "Gold — 10,000g + 5 Gold Bars",
      "upgrades.item4":  "Iridium — 25,000g + 5 Iridium Bars",
      "upgrades.caption": "Upgrades take 2 in-game days. Clint keeps your tool during that time.",
    },
