function render() {
  ...
  if (assetStore.size > 0) {
    ...
    const countBtn = h("button", {
      ...
      onClick:   evt => {
          ...
          const removeBtn = h("button", {
            ...
            onClick:   e => {
              ...
              if (assetStore.size === 0) {
                ...
                row.remove();
                countBtn.textContent = `Images (${assetStore.size}) ▾`;
              }
            }
          }, "✕");
        ...
        setTimeout(() => {
          function closer(e) {
            if (!mountGroup.contains(e.target)) {
              dropdown.remove();
  ...
  if (state.view === "editor") {
    ...
    const mnBar = h("div", { className: "mod-name-bar" });
    mnBar.appendChild(h("label", { className: "mod-name-label", htmlFor: "mod-name-input" }, "MOD NAME"));
    const mnInp = h("input", {
      id:          "mod-name-input",
      name:        "mod-name",
    ...
    mnBar.appendChild(mnInp);
    body.appendChild(mnBar);
